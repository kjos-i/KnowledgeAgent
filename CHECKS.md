...
- **Security (planned)**: smoke_security_injection / _leakage / _supplychain. Live prompt-injection, telemetry-egress, and model-weight SHA checks against real services. Not yet written (audit G follow-up).
