...
# helpers (kg.ontologies.lifecycle.get_canonicalization_candidates)
...
MESH_ID_PREFIX = "MESH"
# Cached source file size. Used by `lifecycle.import_ontology_plan`
...
# pipeline keeps it gzipped on disk (see helpers.ensure_cached's
...
# OntologyProvenance dataclass (from the leaf `provenance`
# module to avoid the circular-import cycle through lifecycle)
