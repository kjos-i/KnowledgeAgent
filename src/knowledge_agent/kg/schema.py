...
CONSTRAINT_STATEMENTS: tuple[str, ...] = (
    ...
    f"CREATE CONSTRAINT go_term_id IF NOT EXISTS "
    f"FOR (t:{GO_TERM_LABEL}) REQUIRE t.id IS UNIQUE",
    f"CREATE CONSTRAINT hpo_term_id IF NOT EXISTS "
    f"FOR (t:{HPO_TERM_LABEL}) REQUIRE t.id IS UNIQUE",
    ...
    f"CREATE CONSTRAINT eco_term_id IF NOT EXISTS "
    f"FOR (t:{ECO_TERM_LABEL}) REQUIRE t.id IS UNIQUE",
    f"CREATE CONSTRAINT so_term_id IF NOT EXISTS "
    f"FOR (t:{SO_TERM_LABEL}) REQUIRE t.id IS UNIQUE",
    f"CREATE CONSTRAINT pr_term_id IF NOT EXISTS "
    f"FOR (t:{PR_TERM_LABEL}) REQUIRE t.id IS UNIQUE",
    f"CREATE CONSTRAINT cl_term_id IF NOT EXISTS "
    f"FOR (t:{CL_TERM_LABEL}) REQUIRE t.id IS UNIQUE",
    f"CREATE CONSTRAINT po_term_id IF NOT EXISTS "
    f"FOR (t:{PO_TERM_LABEL}) REQUIRE t.id IS UNIQUE",
    ...
    f"CREATE CONSTRAINT obi_term_id IF NOT EXISTS "
    f"FOR (t:{OBI_TERM_LABEL}) REQUIRE t.id IS UNIQUE",
    f"CREATE CONSTRAINT efo_term_id IF NOT EXISTS "
    f"FOR (t:{EFO_TERM_LABEL}) REQUIRE t.id IS UNIQUE",
