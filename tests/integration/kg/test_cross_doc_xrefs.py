...
async def _seed_doc_with_canonical_entities(
    client: Any,
    doc_id: str,
...
async def test_recompute_l10_writes_related_by_xref_when_canonicals_match(
    ...
    await _seed_doc_with_canonical_entities(kg_client, DOC_ALPHA, shared)
    await _seed_doc_with_canonical_entities(kg_client, DOC_BETA, shared)
...
async def test_recompute_l10_writes_via_xref_edge_equivalence(
    ...
    await _seed_doc_with_canonical_entities(
        kg_client,
        DOC_ALPHA,
